...
headers_vision = {'Ocp-Apim-Subscription-Key': 'f81ec30b858642db817900b43393822b'} ##62a5fc35cd0e4f058e5249df99a0bdc2
...
def check_for_landmark(msapi_response): # NOTE: you don't need a landmark_list
    ...
    # Initialise our subject to None
    print("Microsoft API Response: {}".format(msapi_response,indent=2))
    subject = None
...
def check_for_text(tile):
    ...
    data = {"url": tile["Tile"]}
    msapi_response = microsoft_api_call(analyse_url, params_analyse, headers_vision, data)
    print("OCR Respnse : {}".format(msapi_response))
